...
-- UserPhone (2 phones per user)
INSERT INTO UserPhone(user_phone_id, web_user_id, phone_number, phone_type_id, created_date)
VALUES
    (1, 1, '555-100-2000', 1, CURRENT_TIMESTAMP),
    (2, 1, '555-100-3000', 2, CURRENT_TIMESTAMP),
    (3, 2, '555-200-2000', 1, CURRENT_TIMESTAMP),
    (4, 2, '555-200-3000', 3, CURRENT_TIMESTAMP);
ALTER SEQUENCE UserPhone_user_phone_id_seq RESTART WITH 5;

-- UserInfo (one per user)
INSERT INTO UserInfo(user_info_id, web_user_id, profile_bio, profile_picture, created_date)
VALUES
    (1, 1, 'I am the main user of this website. I love coding and pizza.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTYZ4AiSTOD6IbZ-zuTTghcjbMr15XMj1XSQ&s', CURRENT_TIMESTAMP),
    (2, 2, 'On the road again. Country music legend with a Texas heart.', 'https://is1-ssl.mzstatic.com/image/thumb/Features125/v4/b4/c2/9a/b4c29a1e-3b45-2b60-be65-dbb96d21e42a/mza_1383128222591135178.png/375x375bb.jpg', CURRENT_TIMESTAMP);
ALTER SEQUENCE UserInfo_user_info_id_seq RESTART WITH 3;

-- PageData (7 weeks of the course)
INSERT INTO PageData(page_data_id, page_name, page_title, page_description, page_picture, page_alt)
VALUES
